...
const Summary = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col mx-auto bg-gradient-to-br from-indigo-200 via-purple-50 to-white md:pb-30">
      <div className="pt-20 px-4 md:px-10 md:pt-32 max-w-7xl w-full mx-auto">

        {/* Top Info */}
        <div className="flex justify-between mb-8 border-b pb-5">
          <div className="flex items-center gap-5">
            <button className="px-5 py-2 text-sm font-semibold text-indigo-600 bg-white rounded-full flex items-center gap-2">
          ...
          <button onClick={() => navigate("/dashboard")} className="px-5 py-2 text-sm bg-indigo-100 rounded-full flex items-center gap-2 cursor-pointer">
            <ArrowLeft className="w-4 h-4 text-indigo-500" /> Back
          </button>
        </div>

        {/* Title */}
        <h1 className="text-3xl font-extrabold text-center sm:text-left mb-8">
          {summaryData.title}
        </h1>
        ...
        <div className="flex flex-col items-center gap-4 mb-10">
          ...
          <div className="flex gap-6">
            <div
              ...
              className="flex items-center gap-2 text-purple-700 cursor-pointer"
            >
            ...
            <div
              ...
              className="flex items-center gap-2 bg-purple-300 px-4 py-2 rounded-md cursor-pointer">
        ...
        {/* ================= SLIDER ================= */}
        {/* ================= SLIDER ================= */}
        <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-gray-200">
          ...
          {/* Content */}
          <div className="relative p-8 min-h-[380px] flex flex-col justify-center">
            ...
            >
              ...
              {content.map((subContent, index) => (
                <div
                  key={index}
                  className="border border-gray-200 rounded-xl p-5 text-left shadow-sm hover:shadow-md transition-all duration-300 bg-white"
                >
                  {subContent}
                </div>
              ))}
          ...
          {/* Controls */}
          <div className="flex justify-between items-center bg-gradient-to-r from-indigo-50 via-purple-50 to-blue-50 px-6 py-5">

            {/* Left */}
            <button
              onClick={prevPage}
              disabled={pageNo === 0}
              className="group p-3 bg-indigo-500 text-white rounded-full shadow-md hover:bg-indigo-600 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
            >
